...
const reviewsData = [
  {
    ...
    text: "Ця сумочка з морською тематикою подорожувала зі мною до Хорватії цього літа, ще стільки захопливих поглядів я не отримувала😍Сама сумка дуже зручна, вміщає все необхідне для прогулянок набережними і є гарним акцентом до моїх літніх образів. Ще раз дуже дякую🤍"
  },
  {
    id: 2,
    image: '/images/reviews/review_2.jpg',
    text: "Отримала свою сумку і дуже рада, що знайшла Вас - дизайн сумки постійно збирає компліменти від моїх знайомих, а ще тішить мене те, що такого не знайдеш в жодному торговому центрі... Дякую, Христино за таку філігранну ручну роботу!"
  },
  {
    id: 3,
    image: '/images/reviews/review_3.jpg',
    text: "Це був подарунок мамі до ювілею, вона просто обожнює рослини. Коли мама побачила цю сумку, вона розплакалася від захвату, ніхто не вірив, що це справжні квіти. Обовʼязково прийду з новою ідеєю до вас, бо це дійсно витвір мистецтва🌸"
  },
];
